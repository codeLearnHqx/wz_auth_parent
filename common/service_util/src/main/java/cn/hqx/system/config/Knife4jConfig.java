...
/**
 * <a href="http://localhost:8080/doc.html">文档链接</a>
 */
...
public class Knife4jConfig {//对于配置类要求可以看懂即可，不用反复去写，将来可以CV
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("cn.hqx"))
    ...
    private static final String API_TILE = "权限管理系统";
